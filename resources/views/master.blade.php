...
<body>
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample02">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/')}}"><b>Accueil</b></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/products')}}">Produits</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/filaments')}}">Filaments</a>
                </li>
              </ul>
            </div>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="{{url('/acp/families')}}">Familles</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{url('/acp/products')}}">Produits</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{url('/acp/filaments')}}">Filaments</a>
      </li>
    </ul>
  </div>
</nav>
